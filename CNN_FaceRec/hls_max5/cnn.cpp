...
#pragma HLS DATAFLOW
    maxPoolLayer<FM_0, KH_1, KW_1, KS_1, DIMH_0, DIMW_0, data_t> (streamDat, streamDat, axiStream);
}

void max5(hls::stream<my_ap_axis<ap_uint<DATA_WIDTH>,DATA_WIDTH,1,1,1> > &axiStreamIn,
