...
void conv3a(hls::stream<my_ap_axis<ap_uint<DATA_WIDTH>,DATA_WIDTH,1,1,1> > &axiStreamIn,
...
int main()
{
	...
	conv3a(axiStreamIn, axiStreamOut, CONV_WEIGHT);
	conv3a(axiStreamIn, axiStreamOut, COMPUTE);
