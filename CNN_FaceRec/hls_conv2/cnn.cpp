...
#pragma HLS DATAFLOW
    convLayer<FM_0, FM_1, KH_1, KW_1, KS_1, KP_1, DIMH_0+2*KP_1, DIMW_0+2*KP_1, data_t, data_t> (streamDat, streamDat, W_conv, b_conv, axiStream);
}
...
void conv2(hls::stream<my_ap_axis<ap_uint<DATA_WIDTH>,DATA_WIDTH,1,1,1> > &axiStreamIn,
