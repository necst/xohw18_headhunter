...
void conv1(hls::stream<my_ap_axis<ap_uint<DATA_WIDTH>,DATA_WIDTH,1,1,1> > &axiStreamIn,
...
int main()
{
	...
	conv1(axiStreamIn, axiStreamOut, CONV_WEIGHT);
	conv1(axiStreamIn, axiStreamOut, COMPUTE);
